package com.example.tp4_gestion_onglet.ui.main;
...
import com.example.tp4_gestion_onglet.R;
...
public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return NatureFragment.newInstance(0, mContext.getString(R.string.titre_section1));
            case 1:
                return NatureFragment.newInstance(1, mContext.getString(R.string.titre_section2));
            case 2:
                return NatureFragment.newInstance(2, mContext.getString(R.string.titre_section3));
            case 3:
                return NatureFragment.newInstance(3, mContext.getString(R.string.titre_section4));
            case 4:
                return NatureFragment.newInstance(4, mContext.getString(R.string.titre_section0));
    }
        return null;
    }
